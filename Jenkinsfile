    ...
    stages {
        ...
        stage('Publish') {
            ...
            steps {
              ...
              sh 'cd dist && tar -czf ../corteza-webapp-admin-${BRANCH_NAME}.tar.gz .'
              sh 'mc --config-dir /tmp/.mc cp ./corteza-webapp-admin-${BRANCH_NAME}.tar.gz minio/corteza-artifacts'
            }
        }
        stage('Build Docker image') {

            steps {
                sh 'docker build -t mrabbah/corteza-webapp-admin:${BRANCH_NAME} --build-arg VERSION=${BRANCH_NAME} . '
            }
        }
        ...
        stage('Push Docker image') {
            ...
            steps {
                ...
                script {
                    ...
                    sh 'docker push mrabbah/corteza-webapp-admin:${BRANCH_NAME}'
                }
